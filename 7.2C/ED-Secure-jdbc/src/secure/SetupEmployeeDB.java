...
public class SetupEmployeeDB {
    ...
    public static void main(String[] args) {
        ...
        Employee emp001 = new Employee("00001", "Adam", "1234567890", "1 John Street, Hawthorn",
                "adam@secure.com.au", SHA256Encoder.encodePassword("11111111"), "ED-APP-ADMIN", "098-765432-1", 50000.0, true);
        Employee emp002 = new Employee("00002", "Bill", "2345678901", "2 Paul Street, Hawthorn",
                "bill@secure.com.au", SHA256Encoder.encodePassword("22222222"), "ED-APP-ADMIN", "109-876543-2", 65000.0, true);
        Employee emp003 = new Employee("00003", "Ceci", "3456789012", "3 Mary Street, Hawthorn",
                "ceci@secure.com.au", SHA256Encoder.encodePassword("33333333"), "ED-APP-USERS", "210-987654-3", 75000.0, true);
        Employee emp004 = new Employee("00004", "Dave", "4567890123", "4 Pete Street, Hawthorn", 
                "dave@secure.com.au", SHA256Encoder.encodePassword("44444444"), "ED-APP-USERS", "321-098765-4", 100000.0, true);
